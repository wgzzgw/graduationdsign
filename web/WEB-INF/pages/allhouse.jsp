    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#tablee').bootstrapTable(
                {
                    url : '.././admin/findAllHouse.do',  //数据请求路径
        ...
        function operateFormatter(value, row, index) {//赋予的参数
            return [
                '<a class="btn active " href="http://localhost:8088/admin/toAdminUpdateHousePage.do?houseId='+row.houseId+'">修改</a>',
        ...
        function onRemove(houseId) {
            if(confirm('确定要删除吗？')) {
                ...
                $.ajax({
                    url: ".././admin/deleteHouse.do?houseId="+houseId,
                    async: false,
                    type: "POST",
                    data: houseId,
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title text-center">所有房源信息</h3>
    </div>
